...
def create_visuals(
    ...
    about = f'Values of the ten most common {section_name.lower()}'
    freq_chart_treat = idw.fig_count_chart(
        counts,
        title=f'Values of {section_name} (SYNTHETIC DATA)',
        suffix=suffix, filepath=filepath, save_inputs=save_inputs,
        graph_id=section,
        graph_label=section_name + ': Values',
        graph_about=about)
    ...
    about = f'Values of the ten most common {section_name.lower()}'
    freq_chart_inter = idw.fig_count_chart(
        counts,
        title=f'Values of {section_name} (SYNTHETIC DATA)',
        suffix=suffix, filepath=filepath, save_inputs=save_inputs,
        graph_id=section,
